...
PROJECT_NUM=$(gcloud projects describe "$PROJECT_ID" --format='value(projectNumber)' --quiet 2>/dev/null || true)
...
build_remote_cloud_build() {
  echo "=== Build remoto en Cloud Build (cloudbuild.yaml + VITE_*) ==="
